...
-Dpath="messages" \
-Dextensions="quarkus-resteasy-jsonb,quarkus-jdbc-postgresql,quarkus-hibernate-orm-panache, quarkus-rest-client, quarkus-smallrye-openapi,quarkus-container-image-jib,quarkus-openshift"
----
