...
[source,bash,subs="+macros,+attributes"]
----
mvn quarkus:add-extension -Dextensions="quarkus-resteasy-jsonb,quarkus-jdbc-postgresql,quarkus-hibernate-orm-panache, quarkus-smallrye-openapi,quarkus-container-image-jib, quarkus-openshift"
----
